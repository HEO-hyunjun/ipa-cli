...
const commands = [
  ...
  ["--profile", "ipa-test", "harness", "install", "opencode", "--json"],
  ["--profile", "ipa-test", "harness", "install", "opencode", "--without", "hook:evidence", "--json"],
  ["--profile", "ipa-test", "harness", "install", "opencode", "--only", "skill,prompt", "--with", "hook:evidence", "--json"],
  ["--profile", "ipa-test", "harness", "status", "--json"],
  ["--profile", "ipa-test", "harness", "doctor", "--json"],
  ["--profile", "ipa-test", "harness", "uninstall", "opencode", "--json"],
  ["--profile", "ipa-test", "harness", "doctor", "--json"],

...
Closes the loop:
  ...
  3. ipa tune --apply --trials 5 → tune/results/{ts}.json + pointer
  4. ipa engine search picks up the new weights via config loader
  5. ipa tune list shows the result with the active marker
"""
